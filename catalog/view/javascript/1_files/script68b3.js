...
e.lblNext&&this._append(this.currentPage+ 1,{text:e.lblNext})},_append:function(e,i){var s,a;e=0>e?0:e<this.pages?e:this.pages- 1,a=t.$.extend({text:e+ 1},i),s=e==this.currentPage?'<li class="uk-active"><span>'+ a.text+"</span></li>":'<li><a href="#page-'+(e+ 1)+'" data-page="'+ e+'">'+ a.text+"</a></li>",this.element.append(s)}}),t.pagination});!function(e,t,s,r){"use strict";e.fn.search=function(n){var a,i=e(this),c=i.selector||"",o=(new Date).getTime(),u=[],l=arguments[0],d="string"==typeof l,g=[].slice.call(arguments,1);return e(this).each(function(){var f,p=e.isPlainObject(n)?e.extend(!0,{},e.fn.search.settings,n):e.extend({},e.fn.search.settings),v=p.className,h=p.metadata,m=p.regExp,b=p.selector,y=p.error,C=p.namespace,R="."+ C,w=C+"-module",x=e(this),j=x.find(b.prompt),q=x.find(b.searchButton),k=x.find(b.results),A=(x.find(b.result),x.find(b.category),this),E=x.data(w);f={initialize:function(){f.verbose("Initializing module"),f.determine.searchFields(),f.bind.events(),f.set.type(),f.create.results(),f.instantiate()},instantiate:function(){f.verbose("Storing instance of module",f),E=f,x.data(w,f)},destroy:function(){f.verbose("Destroying instance"),x.off(R).removeData(w)},bind:{events:function(){f.verbose("Binding events to search"),p.automatic&&(x.on(f.get.inputEvent()+ R,b.prompt,f.event.input),j.attr("autocomplete","off")),x.on("focus"+ R,b.prompt,f.event.focus).on("blur"+ R,b.prompt,f.event.blur).on("keydown"+ R,b.prompt,f.handleKeyboard).on("click"+ R,b.searchButton,f.query).on("mousedown"+ R,b.results,f.event.result.mousedown).on("mouseup"+ R,b.results,f.event.result.mouseup).on("click"+ R,b.result,f.event.result.click)}},determine:{searchFields:function(){n&&n.searchFields!==r&&(p.searchFields=n.searchFields)}},event:{input:function(){clearTimeout(f.timer),f.timer=setTimeout(f.query,p.searchDelay)},focus:function(){f.set.focus(),f.has.minimumCharacters()&&(f.query(),f.showResults())},blur:function(e){var t=s.activeElement===this;t||f.resultsClicked||(f.cancel.query(),f.remove.focus(),f.timer=setTimeout(f.hideResults,p.hideDelay))},result:{mousedown:function(){f.resultsClicked=!0},mouseup:function(){f.resultsClicked=!1},click:function(s){f.debug("Search result selected");var r=e(this),n=r.find(b.title).eq(0),a=r.find("a[href]").eq(0),i=a.attr("href")||!1,c=a.attr("target")||!1,o=(n.html(),n.length>0?n.text():!1),u=f.get.results(),l=r.data(h.result)||f.get.result(o,u);return e.isFunction(p.onSelect)&&p.onSelect.call(A,l,u)===!1?void f.debug("Custom onSelect callback cancelled default select action"):(f.hideResults(),o&&f.set.value(o),void(i&&(f.verbose("Opening search link found in result",a),"_blank"==c||s.ctrlKey?t.open(i):t.location.href=i)))}}},handleKeyboard:function(e){var t,s=x.find(b.result),r=x.find(b.category),n=s.index(s.filter("."+ v.active)),a=s.length,i=e.which,c={backspace:8,enter:13,escape:27,upArrow:38,downArrow:40};if(i==c.escape&&(f.verbose("Escape key pressed, blurring search field"),j.trigger("blur")),f.is.visible())if(i==c.enter){if(f.verbose("Enter key pressed, selecting active result"),s.filter("."+ v.active).length>0)return f.event.result.click.call(s.filter("."+ v.active),e),e.preventDefault(),!1}else i==c.upArrow?(f.verbose("Up key pressed, changing active result"),t=0>n- 1?n:n- 1,r.removeClass(v.active),s.removeClass(v.active).eq(t).addClass(v.active).closest(r).addClass(v.active),e.preventDefault()):i==c.downArrow&&(f.verbose("Down key pressed, changing active result"),t=n+ 1>=a?n:n+ 1,r.removeClass(v.active),s.removeClass(v.active).eq(t).addClass(v.active).closest(r).addClass(v.active),e.preventDefault());else i==c.enter&&(f.verbose("Enter key pressed, executing query"),f.query(),f.set.buttonPressed(),j.one("keyup",f.remove.buttonFocus))},setup:{api:function(){var e={debug:p.debug,on:!1,cache:"local",action:"search",onError:f.error};f.verbose("First request, initializing API"),x.api(e)}},can:{useAPI:function(){return e.fn.api!==r},transition:function(){return p.transition&&e.fn.transition!==r&&x.transition("is supported")}},is:{empty:function(){return""===k.html()},visible:function(){return k.filter(":visible").length>0},focused:function(){return j.filter(":focus").length>0}},get:{inputEvent:function(){var e=j[0],t=e!==r&&e.oninput!==r?"input":e!==r&&e.onpropertychange!==r?"propertychange":"keyup";return t},value:function(){return j.val()},results:function(){var e=x.data(h.results);return e},result:function(t,s){var n=["title","id"],a=!1;return t=t!==r?t:f.get.value(),s=s!==r?s:f.get.results(),"category"===p.type?(f.debug("Finding result that matches",t),e.each(s,function(s,r){return e.isArray(r.results)&&(a=f.search.object(t,r.results,n)[0])?!1:void 0})):(f.debug("Finding result in results object", t), a = f.search.object(t, s, n)[0]),
                ...
                set: {
                    ...
                    type: function(e) {
                        e = e || p.type,
                        "category" == p.type && x.addClass(p.type)
                    },
                ...
                search: {
                    ...
                    remote: function(t) {
                        ...
                        x.api("get request") || f.setup.api(),
                        e.extend(!0, s, p.apiSettings),
                        f.debug("Executing search", s),
                        f.cancel.query(),
                        x.api("setting", s).api("query")
                    },
                    object: function(t, s, n) {
                        ...
                        return s = s || p.source,
                        n = n !== r ? n: p.searchFields,
                        e.isArray(n) || (n = [n]),
                        s === r || s === !1 ? (f.error(y.source), []) : (e.each(n,
                        function(r, n) {
                            e.each(s,
                            function(e, s) {
                ...
                parse: {
                    response: function(e, t) {
                        ...
                        e !== r && t !== r && e.results !== r && (f.addResults(s), f.inject.id(e.results), f.write.cache(t, {
                            html: s,
                            results: e.results
                ...
                create: {
                    id: function(e, t) {
                        var s, n, a = e + 1;
                        return t !== r ? (s = String.fromCharCode(97 + t), n = s + a, f.verbose("Creating category result id", n)) : (n = a, f.verbose("Creating result id", n)),
                        n
                    },
                    results: function() {
                ...
                inject: {
                    ...
                    id: function(t) {
                        ...
                        function(t, a) {
                            ...
                            function(e, t) {
                                var i = a.results[e];
                                i.id === r && (i.id = f.create.id(n, s)),
                                f.inject.result(i, n, s),
                                n++
                            }),
                            s++
                        }) : e.each(t,
                ...
                generateResults: function(t) {
                    ...
                    var s = p.templates[p.type],
                    r = e.isPlainObject(t.results) && !e.isEmptyObject(t.results),
                    n = e.isArray(t.results) && t.results.length > 0,
                    a = "";
                    return r || n ? (p.maxResults > 0 && (r ? "standard" == p.type && f.error(y.maxResults) : t.results = t.results.slice(0, p.maxResults)), e.isFunction(s) ? a = s(t) : f.error(y.noTemplate, !1)) : a = f.displayMessage(y.noResults, "empty"),
                ...
                performance: {
                    ...
                    display: function() {
                        ...
                        (console.group !== r || console.table !== r) && u.length > 0 && (console.groupCollapsed(t), console.table ? console.table(u) : e.each(u,
                        function(e, t) {
                ...
                invoke: function(t, s, n) {
                    ...
                    return s = s || g,
                    n = A || n,
                    "string" == typeof t && u !== r && (t = t.split(/[\. ]/), i = t.length - 1, e.each(t,
                    function(s, n) {
                        var a = s != i ? n + t[s + 1].charAt(0).toUpperCase() + t[s + 1].slice(1) : t;
                        if (e.isPlainObject(u[a]) && s != i) u = u[a];
                        else {
                            if (u[a] !== r) return c = u[a],
                            !1;
                            if (!e.isPlainObject(u[n]) || s == i) return u[n] !== r ? (c = u[n], !1) : !1;
                            u = u[n]
                        }
                    })),
                    e.isFunction(c) ? o = c.apply(n, s) : c !== r && (o = c),
                    e.isArray(a) ? a.push(o) : a !== r ? a = [a, o] : o !== r && (a = o),
                    c
                }
            },
    ...
    e.fn.search.settings = {
        ...
        error: {
            ...
            //noResults: "Your search returned no results",  sales demand for less tip displayed 2017.4.28
            noResults: "",
        ...
        templates: {
            ...
            message: function(e, t) {
                var s = "";
                return e !== r && t !== r && (s += '<div class="message ' + t + '">', s += "empty" == t ? '<div class="header">No Results</div class="header"><div class="description">' + e + '</div class="description">': ' <div class="description">' + e + "</div>", s += "</div>"),
                s
            },
            category: function(t) {
                var s = "",
                n = e.fn.search.settings.templates.escape;
                return t.results !== r ? (e.each(t.results,
                function(t, a) {
                    a.results !== r && a.results.length > 0 && (s += '<div class="category"><div class="name">' + a.name + "</div>", e.each(a.results,
                    function(e, t) {
                        s += '<div class="result">',
                        t.url && (s += '<a href="' + t.url + '"></a>'),
                        t.image !== r && (t.image = n(t.image), s += '<div class="image"> <img src="' + t.image + '" alt=""></div>'),
                        s += '<div class="content">',
                        t.price !== r && (t.price = n(t.price), s += '<div class="price">' + t.price + "</div>"),
                        t.title !== r && (t.title = n(t.title), s += '<div class="title">' + t.title + "</div>"),
                        t.description !== r && (s += '<div class="description">' + t.description + "</div>"),
                        s += "</div></div>"
                    }), s += "</div>")
            ...
            standard: function(t) {
                ...
                return t.results !== r ? (e.each(t.results,
                function(e, t) {
                    s += t.url ? '<a class="result" href="' + t.url + '">': '<a class="result">',
                    t.image !== r && (s += '<div class="image"> <img src="' + t.image + '"></div>'),
                    s += '<div class="content">',
                    t.price !== r && (s += '<div class="price">' + t.price + "</div>"),
                    t.title !== r && (s += '<div class="title">' + t.title + "</div>"),
                    t.description !== r && (s += '<div class="description">' + t.description + "</div>"),
                    s += "</div>",
                    s += "</a>"
                }), t.action && (s += '<a href="' + t.action.url + '" class="action">' + t.action.text + "</a>"), s) : !1
...
function(e, t, r, n) {
    ...
    e.api = e.fn.api = function(r) {
        var o, s = e(e.isFunction(this) ? t: this),
        a = s.selector || "",
        i = (new Date).getTime(),
        u = [],
        c = arguments[0],
        ...
        return s.each(function() {
            var s, g, f, m, p, b, v = e.isPlainObject(r) ? e.extend(!0, {},
            e.fn.api.settings, r) : e.extend({},
            e.fn.api.settings),
            h = v.namespace,
            y = v.metadata,
            q = v.selector,
            ...
            b = {
                ...
                destroy: function() {
                    b.verbose("Destroying previous module for", w),
                    S.removeData(A).off(k)
                },
                bind: {
                    events: function() {
                        var e = b.get.event();
                ...
                query: function() {
                    ...
                    g = b.get.settings(),
                    g === !1 ? (b.cancelled = !0, void b.error(R.beforeSend)) : (b.cancelled = !1, f = b.get.templatedURL(), f || b.is.mocked() ? (f = b.add.urlData(f), f || b.is.mocked() ? (s = e.extend(!0, {},
                    v, {
                        ...
                        b.debug("Sending throttled request", m, s.method),
                        b.send.request()
                    },
                ...
                add: {
                    urlData: function(t, r) {
                        var o, s;
                        return t && (o = t.match(v.regExp.required), s = t.match(v.regExp.optional), r = r || v.urlData, o && (b.debug("Looking for required URL variables", o), e.each(o,
                        function(o, s) {
                            var a = -1 !== s.indexOf("$") ? s.substr(2, s.length - 3) : s.substr(1, s.length - 2),
                            i = e.isPlainObject(r) && r[a] !== n ? r[a] : S.data(a) !== n ? S.data(a) : P.data(a) !== n ? P.data(a) : r[a];
                            return i === n ? (b.error(R.requiredParameter, a, t), t = !1, !1) : (b.verbose("Found required variable", a, i), void(t = t.replace(s, i)))
                        })), s && (b.debug("Looking for optional URL variables", o), e.each(s,
                        function(o, s) {
                    ...
                    formData: function(t) {
                        var r, o = e.fn.serializeObject !== n,
                        s = o ? T.serializeObject() : T.serialize();
                        return t = t || v.data,
                        r = e.isPlainObject(t),
                        r ? o ? (b.debug("Extending existing data with form data", t, s), t = e.extend(!0, {},
                        t, s)) : (b.error(R.missingSerialize), b.debug("Cant extend data. Replacing data with form data", t, s), t = s) : (b.debug("Adding form data", s), t = s),
                        t
                    }
                },
                send: {
                    request: function() {
                        ...
                        v.onRequest.call(j, b.request, b.xhr)
                    }
                },
                event: {
                    trigger: function(e) {
                    ...
                    xhr: {
                        always: function() {},
                            ...
                            i = e.isFunction(v.onResponse) ? v.onResponse.call(o, e.extend(!0, {},
                            t)) : !1;
                            a = a > 0 ? a: 0,
                            i && (b.debug("Modified API response in onResponse callback", v.onResponse, i, t), t = i),
                            a > 0 && b.debug("Response completed early delaying state change by", a),
                            setTimeout(function() {
                    ...
                    request: {
                        complete: function(e) {
                            ...
                            v.onSuccess.call(j, e, S)
                        },
                        fail: function(t, r, o) {
                            var a = e.isPlainObject(t) ? t.responseText: !1,
                            i = e.isPlainObject(a) && a.error !== n ? a.error: v.error[r] !== n ? v.error[r] : o;
                            "aborted" == r ? (b.debug("XHR Aborted (Most likely caused by page navigation or CORS Policy)", r, o), v.onAbort.call(j, r, S)) : "invalid" == r ? b.debug("JSON did not pass success test. A server-side error has most likely occurred", a) : "error" == r && t !== n && (b.debug("XHR produced a server error", r, o), 200 != t.status && o !== n && "" !== o && b.error(R.statusMessage + o, s.url), v.onError.call(j, i, S)),
                            v.errorDuration && "aborted" !== r && (b.debug("Adding error state"), b.set.error(), setTimeout(b.remove.error, v.errorDuration)),
                            b.debug("API Request failed", i, t),
                            v.onFailure.call(j, a, S)
                        }
                    }
                },
                create: {
                    ...
                    mockedXHR: function() {
                        ...
                        v.mockResponse ? (e.isFunction(v.mockResponse) ? (b.debug("Using mocked callback returning response", v.mockResponse), r = v.mockResponse.call(j, v)) : (b.debug("Using specified response", v.mockResponse), r = v.mockResponse), n.resolveWith(j, [r, o, {
                            responseText: r
                        }])) : e.isFunction(v.mockResponseAsync) && (t = function(e) {
                            b.debug("Async callback returned response", e),
                            e ? n.resolveWith(j, [e, o, {
                                responseText: e
                            }]) : n.rejectWith(j, [{
                                responseText: e
                            },
                        ...
                        b.debug("Using async mocked response", v.mockResponseAsync), v.mockResponseAsync.call(j, v, t)),
                        n
                    },
                    xhr: function() {
                        var t;
                        return t = e.ajax(s).always(b.event.xhr.always).done(b.event.xhr.done).fail(b.event.xhr.fail),
                        b.verbose("Created server request", t),
                        t
                    }
                },
                set: {
                ...
                get: {
                    ...
                    settings: function() {
                        var e;
                        return e = v.beforeSend.call(j, v),
                        e && (e.success !== n && (b.debug("Legacy success callback detected", e), b.error(R.legacyParameters, e.success), e.onSuccess = e.success), e.failure !== n && (b.debug("Legacy failure callback detected", e), b.error(R.legacyParameters, e.failure), e.onFailure = e.failure), e.complete !== n && (b.debug("Legacy complete callback detected", e), b.error(R.legacyParameters, e.complete), e.onComplete = e.complete)),
                        e === n && b.error(R.noReturnedValue),
                        e !== n ? e: v
                    },
                    defaultData: function() {
                        var t = {};
                        return e.isWindow(w) || (b.is.input() ? t.value = S.val() : b.is.form() && (t.text = S.text())),
                        t
                    },
                    event: function() {
                    ...
                    templatedURL: function(e) {
                        if (e = e || S.data(y.action) || v.action || !1, f = S.data(y.url) || v.url || !1) return b.debug("Using specified url", f),
                        f;
                        if (e) {
                ...
                setting: function(t, r) {
                    if (b.debug("Changing setting", t, r), e.isPlainObject(t)) e.extend(!0, v, t);
                    else {
                        if (r === n) return v[t];
                        v[t] = r
                    }
                ...
                error: function() {
                    b.error = Function.prototype.bind.call(console.error, console, v.name + ":"),
                ...
                performance: {
                    ...
                    display: function() {
                        ...
                        t += " " + r + "ms",
                        a && (t += " '" + a + "'"),
                        (console.group !== n || console.table !== n) && u.length > 0 && (console.groupCollapsed(t), console.table ? console.table(u) : e.each(u,
                        function(e, t) {
                            console.log(t.Name + ": " + t["Execution Time"] + "ms")
                        }), console.groupEnd()),
                        u = []
                ...
                invoke: function(t, r, s) {
                    ...
                    return r = r || l,
                    s = w || s,
                    "string" == typeof t && c !== n && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t,
                    function(r, o) {
                        var s = r != a ? o + t[r + 1].charAt(0).toUpperCase() + t[r + 1].slice(1) : t;
                        if (e.isPlainObject(c[s]) && r != a) c = c[s];
                        else {
                            if (c[s] !== n) return i = c[s],
                            !1;
                            if (!e.isPlainObject(c[o]) || r == a) return c[o] !== n ? (i = c[o], !1) : (b.error(R.method, t), !1);
                            c = c[o]
                        }
                    })),
                    e.isFunction(i) ? u = i.apply(s, r) : i !== n && (u = i),
...
(function($) {
    ...
    var layoutManager = {
        ...
        defaultConfig: {
            animate: false,
            cellW: 100,
            // function(container) {return 100;}
            cellH: 100,
            // function(container) {return 100;}
            delay: 0,
            // slowdown active block;
            engine: 'giot',
            fixSize: null,
            // resize + adjust = fill gap;
            //fixSize: 0, resize but keep ratio = no fill gap;
            //fixSize: 1, no resize + no adjust = no fill gap;
            gutterX: 15,
            // width spacing between blocks;
            gutterY: 15,
            // height spacing between blocks;
            keepOrder: false,
            selector: '> div',
            draggable: false,
            cacheSize: true,
            // caches the original size of block;
            rightToLeft: false,
            bottomToTop: false,
            onGapFound: function() {},
            onComplete: function() {},
        ...
        loadBlock: function(item, setting) {
            ...
            isNaN(fixSize) && (fixSize = null); (fixSize == null) && (fixSize = setting.fixSize);
        ...
        adjustUnit: function(width, height, setting) {
            ...
            cellW = 1 * cellW; ! $.isNumeric(cellW) && (cellW = 1);

            $.isFunction(cellH) && (cellH = cellH(height));
            cellH = 1 * cellH; ! $.isNumeric(cellH) && (cellH = 1);
        ...
        getFreeArea: function(t, l, runtime) {
            ...
            for (var y = t; y < minY; ++y) {
                for (var x = l; x < maxX; ++x) {
                    if (matrix[y + '-' + x]) { (l < x && x < minX) && (minX = x);
                    }
                }
            }
            ...
            for (var y = t; y < maxY; ++y) {
                for (var x = l; x < minX; ++x) {
                    if (matrix[y + '-' + x]) { (t < y && y < minY) && (minY = y);
                    }
                }
            }
    ...
    function Freewall(selector) {
        ...
        var setting = $.extend({},
        layoutManager.defaultConfig);
        var runtime = {
            arguments: null,
            blocks: {},
            // store all items;
            events: {},
            // store custome events;
            matrix: {},
            holes: {},
            // forbidden zone;
            cellW: 0,
            ...
            // min height of block;
            running: 0,
            // flag to check layout arranging;
            gutterX: 15,
            gutterY: 15,
        ...
        if (!layoutManager.transition) { (bodyStyle.webkitTransition != null || bodyStyle.MozTransition != null || bodyStyle.msTransition != null || bodyStyle.OTransition != null || bodyStyle.transition != null) && (layoutManager.transition = true);
        }
        ...
        $.extend(klass, {
            ...
            addCustomEvent: function(name, func) {
                ...
                name = name.toLowerCase(); ! events[name] && (events[name] = []);
...
function(a) {
    a.fn.ZooMove = function(b) {
        ...
        b);
        c.cursor = "true" === c.cursor ? "crosshair": "default",
        this.each(function() {
            c.overD = a(this).attr("zoo-over") ? a(this).attr("zoo-over") : c.over,
            "true" === c.overD && a(this).css({
                overflow: "visible",
                "z-index": "100"
            }),
            c.imageD = a(this).attr("zoo-image") ? a(this).attr("zoo-image") : c.image,
            a(this).append('<div class="zoo-img"></div>').children(".zoo-img").css({
        ...
        function(b) {
            b.preventDefault(),
            c.scaleD = a(this).attr("zoo-scale") ? a(this).attr("zoo-scale") : c.scale,
            c.moveD = a(this).attr("zoo-move") ? a(this).attr("zoo-move") : c.move,
            a(this).children(".zoo-img").css({
                transform: "scale(" + c.scaleD + ")"
            })
        }).on("mousemove",
        function(b) {
            b.preventDefault(),
            "true" === c.moveD && a(this).children(".zoo-img").css({
                "transform-origin": (b.pageX - a(this).offset().left) / a(this).width() * 100 + "% " + (b.pageY - a(this).offset().top) / a(this).height() * 100 + "%"
            })
        }).on("mouseout",
        function(b) {
            b.preventDefault(),
...
jQuery(function($) {
    ...
    jQuery('.search.button').on('click',
    function(event) {
//        jQuery('#searchform').form('submit');
        jQuery(this).closest('#searchform').form('submit');
    });

    jQuery(".ui.search").search({
        apiSettings: {
            url: hr + "portal/index/loadsearch/?keyword={query}",
            ...
            onResponse: function(serverResponse) {
                ...
                jQuery.each(serverResponse.subtopics,
                function(index, item) {
    ...
    jQuery('.productmenu[data-uk-dropdown]').on('hide.uk.dropdown',
    function() {
    ...
    jQuery('#contact[data-uk-accordion]').on('toggle.uk.accordion',
    function() { // Nav > Category > Style it
    ...
    jQuery('[data-uk-dropdown]').on('show.uk.dropdown',
    function() { // Nav > Category > Style it
    ...
    jQuery('.carerr-pag[data-uk-pagination]').on('select.uk.pagination',
    ...
    jQuery('.product-pag[data-uk-pagination]').on('select.uk.pagination',
    function(e, pageIndex) {
        //alert('You have selected page: ' + (pageIndex+1));
    ...
    jQuery('.post-pag[data-uk-pagination]').on('select.uk.pagination',
    function(e, pageIndex) {
        //alert('You have selected page: ' + (pageIndex+1));
    ...
    jQuery('.gallery-pag[data-uk-pagination]').on('select.uk.pagination',
    function(e, pageIndex) {
        //alert('You have selected page: ' + (pageIndex+1));
    ...
    jQuery('#categorygrid[data-uk-grid]').on('beforeupdate.uk.grid',
    function(e, children) {

        jQuery('#category-tab li a').on('click',
        function() { // Click Tab
    ...
    jQuery('#categorygrid[data-uk-grid]').on('afterupdate.uk.grid',
    function(e, children) { // After Tab Active
        setTimeout("jQuery('.category-list').removeClass('loading');", 300);
    });

    jQuery('.faqlist .uk-accordion-title').on('click',
    function(event) {
    ...
    jQuery('.move-reset,.move-signup,.move-login').on('click',
    function(event) { // Switch the Login / Register / Reset Password form
    ...
    jQuery('.color-switcher[data-uk-slideset]').on('show.uk.slideset',
    function(e, children) {
    ...
    jQuery('#home-slider[data-uk-slideshow]').on('beforeshow.uk.slideshow',
    function(event, next, current) { // Clear all the validate message after hidden
        //console.log(next);
    ...
    jQuery('#support-form select').on('change',
    function(event) {
        jQuery('#support-form #ass').val(jQuery('#support-form select[name="amazonsite"]').dropdown('get text'));
    });

    jQuery('[data-uk-tab]').on('change.uk.tab',
    function(event, area) {
        //console.log(event);
        jQuery('form').form('reset');
    });

    jQuery('.usermenus[data-uk-tab]').on('change.uk.tab',
    function(event, area) {
    ...
    jQuery('.messagemenu[data-uk-tab]').on('change.uk.tab',
    function(event, area) {
    ...
    function() {
        ...
        jQuery.post('/user/user/logout', data,
        function(response) {
            ...
            if (response.success == false) {
                ...
                setTimeout("window.location.href = jQuery('.logo').attr('href');", 500);

            }
        },'json');
    });

    jQuery('#myproduct-form .submit').on('click',
    function() {
        jQuery('.registerarea').addClass('loading');
    });

    jQuery('.resendactivate').on('click',
    function() {
        ...
        jQuery.post('/user/user/resendactivate', data,
        function(response) {
    ...
    jQuery('body.search .dadsf i.search').on('click',
    function(event) {
...
jQuery('.testit').on('click',
    function(event) {
        if (jQuery('body').hasClass('loginon')) {
            $.UIkit.notify('Please login. ', {
                status: 'danger'
            });
            jQuery('.user-section').addClass('uk-open').show();
            jQuery('.uk-dropdown.uk-dropdown-width-2.tm-dropdown.uk-margin-top-remove').css({'top': '80px', 'left': '-202px'}).attr("aria-expanded", true);
        } else {
    ...
    $.fn.form.settings.rules.checkInfo = function(value, action) {
        ...
        if(action == 'checkifsubcribed'){
            ajax_object.ajaxurl = '/admin/subscription/checkemail';
        }
        jQuery.ajax({
    ...
    jQuery('.loginform').form({
        ...
        onSuccess: submitLogForm
    });
    function submitLogForm(){
        var data = $(".loginform").serialize();
        jQuery.post('/user/user/login', data,
                function(response) {
    ...
    function resetpasswordForm() {
        ...
        jQuery.post('/user/user/resetpassword', data,
        function(response) {
            if (response.success == false) {
                return false;
            } else {
    ...
    /*jQuery('.changepassword').form({
        ...
        onSuccess: changepasswordsubmitForm
    });
    function changepasswordsubmitForm() {
        ...
        jQuery.post('/user/user/resetpass', data,
        function(response) {
...
//                }
    ...
    jQuery('.newsleeterform').form({
        ...
        fields: {
            newsletter: {
                ...
                //                    },
                {
                    ...
                    prompt: '{value} has been subscribed already'
                }]
            },
        },
        onFailure: function() {
        ...
        onSuccess: emailSubmitForm,
    });
    
    function emailSubmitForm(){
        var data = $(".newsleeterform").serialize();
        jQuery.post('/admin/subscription/addemail', data,
                function(response) {
                    if (response.status == 1) {
                        var window_height = $(window).height();
                        $("#contact_float_block").css("top", window_height / 2 + "px");
                        $("#contact_form_comm").css("display", "block");
                        $("#contact_ctn").html(response.info);
                        //window.location.href = "/";
                    }else{
                        //alert(response.info);
                    }
    ...
    function submitContactForm() {
        ...
        // } else {
            var data = {
                ...
                security: jQuery(this).form('get field', '_nonce').val(),
                form: jQuery(this).serializeArray(),
                success_notice: jQuery(this).form('get field', 'success_notice').val(),
            };
            //console.log(data);
            //console.log(email);
        
            jQuery.post("/portal/contacts/contact", data,
            function(response) {
                jQuery('form').removeClass('loading');
                jQuery('.uk-notify').find('.uk-notify-message').first().remove();
//                console.log(response);
                ...
                if (response.success == true) {
                    ...
                    $("#contact_float_block").css("top", window_height / 2 + "px");
                    $("#contact_form_comm").css("display", "block");
                    $("#contact_ctn").html(data.success_notice);
    ...
    function registerProductSubmit() {
        ...
        jQuery.post('/user/user/registeredproduct', data,
        function(response) {
            jQuery('form').removeClass('loading');
            ...
            $("#contact_float_block").css("top", window_height / 2 + "px");
            $("#contact_form_comm").css("display", "block");
            $("#contact_ctn").html('Update Completed');
    ...
    function userinfosubmitForm() {
        ...
        jQuery.post('/user/user/editaccount', data,
        function(response) {
...
//                SuccessNotify();
                ...
                $("#contact_form_comm").css("display", "block");
                $("#contact_ctn").html('Update Completed');
                if(jQuery(".userniceemail").prop('disabled') == false){
                    jQuery(".userniceemail").attr("disabled","disabled");
                }
            }else{
    ...
    var careermodal = UIkit.modal("#career-apply", {
        target: '#career-apply',
        center: true,
        bgclose: false
    });
    ...
    function careerForm() {
        var formData = new FormData($( "#careerapply-form" )[0]);
        $.ajax({ 
                url: '/portal/careers/sendcareeremail' , 
                type: 'POST', 
                data: formData, 
                async: false, 
                cache: false, 
    ...
    settings = {
        ...
        notallowed: function(file, settings) {
            ...
            $.UIkit.notify('Please submit your resume and cover letter in doc, docx, or preferably PDF format', {
                status: 'info'
            });
    ...
    careersettings = {
        ...
        action: "/portal/careers/careerupload",
        // upload url
        params: {
    ...
    jQuery('.resume-upload-select').on('change',
    function(event) {

        //jQuery('input[name="resumename"]').attr('value', event.currentTarget.value);
        jQuery('input[name="resumename"]').val(event.currentTarget.value);

    });

    jQuery('#resume-upload-drop').on('drop',
    function(event) {
    ...
    jQuery('.cover-upload-select').on('change',
    function(event) {

        //jQuery('input[name="covername"]').attr('value', event.currentTarget.value);
        jQuery('input[name="covername"]').val(event.currentTarget.value);

    });

    jQuery('#cover-upload-drop').on('drop',
    function(event) {
        ...
        if (jQuery('body').has('tax-productcate') && d != null) {
            if (jQuery("#defaultspy").length > 0) {
                jQuery("html,body").animate({
                    scrollTop: jQuery("#defaultspy").offset().top
                },
                300,
                function() {
    ...
    function SuccessNotify() {
        $.UIkit.notify("<i class='uk-icon-check'></i> Update Completed", {
            status: 'success'
        });
    }

    function SentSuccessNotify() {
        $.UIkit.notify("<i class='uk-icon-check'></i> Sent successfully", {
            status: 'success'
        });
    }

    function UploadSuccessNotify() {
        $.UIkit.notify("<i class='uk-icon-check'></i> Upload Completed", {
            status: 'success'
        });
    }
