<?php
class ControllerDescriptionAboutUs extends Controller {
...
//        var_dump($data['list1']);exit;
        ...
        $this->response->setOutput($this->load->view('description/about_us', $data));
    }
...
//        var_dump($data['list1']);exit;
        ...
        $this->response->setOutput($this->load->view('description/contact', $data));
    }
}